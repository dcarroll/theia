...
describe("Terminal Backend Contribution", function () {
    ...
    before(function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        application = inversify_spec_config_1.testContainer.get(backend_application_1.BackendApplication);
                        shellTerminalServer = inversify_spec_config_1.testContainer.get(shell_terminal_protocol_1.IShellTerminalServer);
    ...
    it("is data received from the terminal ws server", function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, shellTerminalServer.create({})];
                    case 1:
                        terminalId = _a.sent();
                        p = new Promise(function (resolve, reject) {
                            var socket = new ws("ws://localhost:" + server.address()
