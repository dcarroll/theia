...
var TerminalFrontendContribution = /** @class */ (function () {
    function TerminalFrontendContribution(app, widgetManager, workspaceService) {
        this.app = app;
    ...
    TerminalFrontendContribution.prototype.registerKeybindings = function (keybindings) {
        [
            {
                commandId: TerminalCommands.NEW.id,
                keyCode: common_1.KeyCode.createKeyCode({ first: common_1.Key.BACKQUOTE, modifiers: [common_1.Modifier.M1] })
            },
