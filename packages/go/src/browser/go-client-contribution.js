...
var GoClientContribution = /** @class */ (function (_super) {
    __extends(GoClientContribution, _super);
    function GoClientContribution(workspace, languages, languageClientFactory) {
    ...
    Object.defineProperty(GoClientContribution.prototype, "documentSelector", {
        get: function () {
            return [
                'go'
            ];
    ...
    Object.defineProperty(GoClientContribution.prototype, "globPatterns", {
        get: function () {
            return [
                '**/*.go'
            ];
    ...
    GoClientContribution = __decorate([
    ...
    ], GoClientContribution);
    return GoClientContribution;
}(browser_1.BaseLanguageClientContribution));
exports.GoClientContribution = GoClientContribution;
//# sourceMappingURL=go-client-contribution.js.map