...
export declare const extensionPath = "/services/extensions";
/**
 * The raw extension information from the repository.
 */
export declare class RawExtension {
 ...
 */
export declare class ResolvedRawExtension extends RawExtension {
    /**
 ...
 */
export declare class Extension extends RawExtension {
    /**
 ...
 */
export declare type ResolvedExtension = Extension & ResolvedRawExtension;
/**
...
export declare const ExtensionServer: symbol;
/**
...
export declare type ExtensionChange = Pick<Extension, 'name'> & Partial<Extension>;
export declare const ExtensionClient: symbol;
/**
