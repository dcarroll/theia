...
function open(openerService, uri, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, openerService.getOpener(uri)];
                case 1:
                    opener = _a.sent();
                    return [4 /*yield*/, opener.open(uri, options)];
...
var DefaultOpenerService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, Promise.reject("There is no opener for " + uri + ".")];
                }
            });
        });
    };
    ...
    DefaultOpenerService.prototype.prioritize = function (uri, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, common_1.Prioritizeable.prioritizeAll(this.getHandlers(), function (handler) {
