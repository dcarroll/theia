...
var quick_command_service_1 = require("./quick-command-service");
...
var QuickCommandFrontendContribution = /** @class */ (function () {
    ...
    QuickCommandFrontendContribution.prototype.registerCommands = function (commands) {
        ...
        commands.registerCommand(exports.quickCommand, {
            execute: function () { return _this.quickCommandService.open(); }
        });
    };
    QuickCommandFrontendContribution.prototype.registerKeybindings = function (keybindings) {
        keybindings.registerKeybinding({
            ...
            keyCode: common_1.KeyCode.createKeyCode({ first: common_1.Key.F1 })
        });
        keybindings.registerKeybinding({
            commandId: exports.quickCommand.id,
            keyCode: common_1.KeyCode.createKeyCode({ first: common_1.Key.KEY_P, modifiers: [common_1.Modifier.M1, common_1.Modifier.M2] })
        });
    };
    __decorate([
