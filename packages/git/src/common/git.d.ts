 ...
 */
export declare const GitPath = "/services/git";
/**
 * Git symbol for DI.
 */
export declare const Git: symbol;
 ...
 */
export declare namespace GitUtils {
    /**
     * `true` if the argument is an option for renaming an existing branch in the repository.
     */
    function isBranchRename(arg: any | undefined): arg is Git.Options.Branch.Rename;
    /**
     * `true` if the argument is an option for deleting an existing branch in the repository.
     */
    function isBranchDelete(arg: any | undefined): arg is Git.Options.Branch.Delete;
    /**
     * `true` if the argument is an option for creating a new branch in the repository.
     */
    function isBranchCreate(arg: any | undefined): arg is Git.Options.Branch.Create;
    /**
     * `true` if the argument is an option for listing the branches in a repository.
     */
    function isBranchList(arg: any | undefined): arg is Git.Options.Branch.List;
    /**
     * `true` if the argument is an option for checking out a new local branch.
     */
    function isBranchCheckout(arg: any | undefined): arg is Git.Options.Checkout.Branch;
    /**
     * `true` if the argument is an option for checking out a working tree file.
     */
    function isWorkingTreeFileCheckout(arg: any | undefined): arg is Git.Options.Checkout.WorkingTreeFile;
}
