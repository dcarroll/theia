...
var OutlineViewContribution = /** @class */ (function () {
    function OutlineViewContribution(widgetManager) {
        this.widgetManager = widgetManager;
    }
    OutlineViewContribution.prototype.initializeLayout = function (app) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.widgetManager.getOrCreateWidget('outline-view').then(function (outline) {
