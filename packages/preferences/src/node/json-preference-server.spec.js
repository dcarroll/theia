...
before(function () {
    ...
    fs.writeFileSync(file_uri_1.FileUri.fsPath(preferenceFileUri), '{ "showLineNumbers": false }');
});
after(function () {
    prefServer.dispose();
    track.cleanupSync();
});
describe('json-preference-server', function () {
    describe('Json pref server client', function () {
        it('Register a client and change the value', function () { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            var promise, fileContent, content;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        promise = new Promise(function (done) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
...
//# sourceMappingURL=json-preference-server.spec.js.map